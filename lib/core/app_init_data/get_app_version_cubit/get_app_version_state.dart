...
final class AinnaBatchUnmatched extends AppRequiredVersionState {
  final String latestVersion;
  ...
  const AinnaBatchUnmatched(
    this.latestVersion,
    this.highProtectBatchUrl,
    this.lowProtectBatchUrl,
    this.isNecessaryUpdate,
    this.reasonMessage,
  ) : assert(highProtectBatchUrl != null || lowProtectBatchUrl != null);
